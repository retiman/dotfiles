...
syn keyword javaExternal		goto const
syn keyword javaExternal	if else switch
syn keyword javaExternal		while for do
syn keyword javaConstant		true false
syn keyword javaConstant	null
syn keyword javaTypedef		this super
syn keyword javaExternal	new instanceof
syn keyword javaExternal		boolean char byte short int long float double
syn keyword javaExternal		void
syn keyword javaExternal	return
syn keyword javaExternal	static synchronized transient volatile final strictfp serializable
syn keyword javaExternal	throw try catch finally
syn keyword javaExternal		assert
syn keyword javaExternal	synchronized throws
syn keyword javaExternal	extends implements class enum interface
" to differentiate the keyword class from MyClass.class we use a match here
syn match   javaAnnotation	"@\([_$a-zA-Z][_$a-zA-Z0-9]*\.\)*[_$a-zA-Z][_$a-zA-Z0-9]*\>"
syn keyword javaExternal		break continue nextgroup=javaUserLabelRef skipwhite
syn match   javaUserLabelRef	"\k\+" contained
syn match   javaVarArg		"\.\.\."
syn keyword javaExternal	public protected private abstract
